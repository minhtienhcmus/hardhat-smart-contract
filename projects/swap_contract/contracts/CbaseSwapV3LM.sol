...
import {ICbaseSwapV3LM} from './interfaces/ICbaseSwapV3LM.sol';
import {ICbaseRewardLockerV2} from './interfaces/ICbaseRewardLockerV2.sol';
...
contract CbaseSwapV3LM is ICbaseSwapV3LM, AccessControl, LMHelper, ReentrancyGuard {
  ...
  ICbaseRewardLockerV2 public immutable rewardLocker;
  ...
  constructor(IERC721 _nft, ICbaseRewardLockerV2 _rewardLocker) {
    nft = _nft;
