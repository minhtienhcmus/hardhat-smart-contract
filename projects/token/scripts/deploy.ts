...
const main = async () => {
  ...
  console.log("======================")
  const  factory = await ethers.getContractFactory("Uni");
  const ffac = await factory.deploy("0xcB8A5dFE06a4231156f7cF5600754cDc51371501","0xcB8A5dFE06a4231156f7cF5600754cDc51371501","1716890742");
  await ffac.deployed();
  console.log("Token:",ffac.address);
