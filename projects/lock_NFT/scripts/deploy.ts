...
const main = async () => {
  ...
  console.log("======================")
  const  UNCX_ProofOfReservesV2_UniV3 = await ethers.getContractFactory("UNCX_ProofOfReservesV2_UniV3");
  const ffac = (await UNCX_ProofOfReservesV2_UniV3.deploy(config.WETH[name]));
  await ffac.deployed();
