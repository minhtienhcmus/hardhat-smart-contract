...
interface ILockFactory {
    ...
    struct Lock {
        ...
        IBasePositionManager nftPositionManager; // the nft position manager of the uniswap fork
    ...
    struct LockParams {
        IBasePositionManager nftPositionManager; // the NFT Position manager of the Uniswap V3 fork
    ...
    function increaseLiquidity(uint256 lockId, IBasePositionManager.IncreaseLiquidityParams calldata params) external payable returns (uint128 liquidity, uint256 amount0, uint256 amount1);
    ...
    event onLock(
        ...
        uint256 collectFee,
        address poolAddress,
        IBasePositionManager.Position position
    );
